...
Modeling count data for Tumour spheres and Adherent conditions.
For RNA-seq with 4 treatment and 4 control, treatment = columns 1:4, treatment = control 5:8
```{r echo=FALSE, warning=FALSE, message=FALSE}
...
So both options to add CPM filtering or use the raw counts straight into DESeq2 can be tried. For this, the variable "RNA_seq_final" can be swapped for "RNA_seq_counts_filtered" to use the CPM filtered one instead.
