...
Within the results, the gene symbols and Entrez IDs for enrichKEGG would be found in the SYMBOL & ENTREZID columns respectively.
Get Ensembl ID character vector for genes that have a adjusted p-value < 0.05 and a Fold change > 4.
```{r echo=FALSE, warning=FALSE, message=FALSE}
