...
# For all genes:
write.csv(as.data.frame(RNA_seq_res_table_tb), file="all_genes_Rh30_Ts_vs_Ad.csv")
# For genes that pass the cut-offs above:
write.csv(as.data.frame(RNA_seq_sigDEGS), file="FC>2_padj<05_Rh30_Ts_vs_Ad.csv")
```
